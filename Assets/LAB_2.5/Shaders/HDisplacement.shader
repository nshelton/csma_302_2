Shader "Unlit/HDisplacementWater"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                col.rgb = col.bgr;
                //col *= dot(worldNormalFromMap(i, _NormalTex), lightDir) * 3;
                col *= dot(worldNormalFromMap(i, _WetNormal), lightDir) * 3;
                return col;
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                o.vertex = UnityObjectToClipPos(v.vertex* 1.2 + displacement);
            ...
            {                
                ...
                fixed4 col = tex2D(_WaterTex, i.uv + _SinTime);
                col -= lightDir.x / 3;
                return col;
            }
            ENDCG
