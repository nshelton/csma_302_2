Shader "Unlit/clip"
{
    Properties
    {
        ...
        _Clip("clip", Float) = 800 //for best results keep the number between 820 and 880 and just go between those values to see the object clip
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
               ...
               clip(sin(i.worldPos.y * _Clip/1000));
