...
fixed4 frag(v2f i) : SV_Target
{
    ...
    // This is the distance formula --> c = sqrt(a^2 + b^2); it computes the distance between obj world position with plane generated
    ...
    // Clip the object based on the distance from the plane
    clip(dist);
