Shader "Unlit/strip_movement"
{
     ...
     SubShader
     {
         ...
         {
             //makes clipping illusion
             clip(sin(i.worldPos.y * 10 * sin(_Time.z)));
             ...
             //alters brightness of chosen color from 0 to 1
             col = _brightness * sin(_Time.y) + _color;
