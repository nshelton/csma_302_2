Shader "Unlit/Toon"
{
    ...
    Properties
    {
        ...
        fixed4 frag(v2f i) : SV_Target
        {
            ...
            diffuse - smoothstep(_toonThreshold - 0.1, _toonThreshold - 0.1, diffuse);
            fixed4 col = diffuse * _color;

            col += _ambient;

            float3 r = reflect(lightDir, n);
            float specAngle = dot(r, viewDir);
            specAngle = smoothstep(_toonThreshold - 0.1, _toonThreshold - 0.1, specAngle);
